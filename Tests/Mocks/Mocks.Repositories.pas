...
type
  ICustomerRepository = interface
    ...
    function Stream: Stream<TCustomer>;
...
{----------------------------------------------------------------------------------------------------------------------}
function TCustomerRepository.Stream: Stream<TCustomer>;
begin
  Result.InitializeFrom(fCustomers);
end;
...
{----------------------------------------------------------------------------------------------------------------------}
function TSaleRepository.Stream: Stream<TSale>;
begin
...
{----------------------------------------------------------------------------------------------------------------------}
function TCarSaleRepository.Stream: Stream<TSale>;
begin
  Result.InitializeFrom(fSales);
end;
